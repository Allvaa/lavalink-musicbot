...
module.exports = {
    ...
    exec: (ctx) => {
        ...
        if (!music.player) return ctx.respond({ embeds: [util.embed().setDescription("❌|  Currently not playing anything.")] });
        ...
        ctx.respond({ embeds: [util.embed().setDescription("✅ | Removed all Dupes")] }).catch(e => e);
    }
};
